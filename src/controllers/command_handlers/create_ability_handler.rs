...
use toml;
use crate::{models::ability::Ability, models::cli::CreateArgs, views::inputs};
...
fn create_ability() -> Ability {
    ...
    Ability::new(name, description, attack_bonus, damage_bonus, damage_dice, count)
}

fn flush_to_file(attack: Ability, path: &str) {
